          ...
          return (
            <li key={i} className="flex gap-3 pb-3">
              ...
              <div className="flex flex-col items-center pt-1 w-14 shrink-0">
                <span
                  className={`latin text-xs font-extrabold ${
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-left">
          <p className="latin text-2xl font-extrabold tabular-nums">
            {d > 0 && `${toArabicDigits(d)}ي `}
            {toArabicDigits(String(h).padStart(2, "0"))}:
            {toArabicDigits(String(m).padStart(2, "0"))}:
            {toArabicDigits(String(s).padStart(2, "0"))}
          </p>
        </div>
      </div>
    </div>
